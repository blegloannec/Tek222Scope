...
# NB: Utiliser le channel *actif* sur l'oscillo pour recuperer les donnees
#     en mode XY !

class Tek222:
    def __init__(self, device):
        # Noms des boutons (cf manuel)
        self.Buttons = {'CLEAR' : '1',
                        ...
                        'Variable Gain' : '21',
                        'AUTO LVL: PUSH' : '22'}
        # Ouverture de port serie (peut lancer une exception, non rattrapee ici)
